...
class TestCases(unittest.TestCase):
    ...
    def test_RemoveCycles(self):
        ...
        # expanded_paths = expand(Path(7), self.map)
        expanded_paths = [Path([6, 8, 4, 3, 7]), Path([6, 8, 4, 3, 2]),
                          Path([6, 8, 4, 3, 6]), Path([6, 8, 4, 3, 8]), Path([6, 8, 4, 3, 1])]
    ...
    def test_calculate_cost(self):
        ...
        list_of_path = [Path([10, 23, 22, 21, 20, 19, 18, 11, 12, 13])]
    ...
    def test_calculate_heuristics(self):
        expanded_paths = [Path([15, 14])]
        updated_paths = calculate_heuristics(expanded_paths, self.map, destination_id=10, type_preference=2)
        print("UWU")
        print(updated_paths[0].h)
    ...
    def test_remove_redundant_path(self):
        ...
        path_1 = self.create_path_with_g([4, 6, 3], 84.52)
        path_2 = self.create_path_with_g([4, 6, 1], 235.23)
        path_3 = self.create_path_with_g([4, 6, 7], 350.12)
        path_4 = self.create_path_with_g([4, 6, 5, 0], 350.12)
    ...
    def test_Astar(self):
        ...
        optimal_path = Astar([88, 69], [192, 195], self.map, 0)
        print("AAAAAAAAAAAA")
        ...
        optimal_path = Astar([88, 69], [192, 195], self.map, 3)
        print("AAAAAAAAAAAA")
        print(optimal_path.route, optimal_path.f)
        self.assertEqual(optimal_path, Path([3, 2, 10, 11, 12, 13, 14]))
        self.assertEqual(optimal_path.f, 2)
